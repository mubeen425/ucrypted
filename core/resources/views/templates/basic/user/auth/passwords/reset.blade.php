                    ...
                    <div class="account-form">
                        ...
                        <form method="POST" action="{{ route('user.password.update') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control form--control @if($general->secure_password) secure-password @endif " name="password" placeholder="@lang('Enter password')" required>
                            </div>
                            <div class="form-group">
